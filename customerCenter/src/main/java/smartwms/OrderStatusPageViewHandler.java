...
@Service
public class OrderStatusPageViewHandler {


    @Autowired
    private OrderStatusPageRepository orderStatusPageRepository;
    ...
    @StreamListener(KafkaProcessor.INPUT)
    public void whenOrderChanged_then_UPDATE_3(@Payload OrderChanged orderChanged) {
        try {
