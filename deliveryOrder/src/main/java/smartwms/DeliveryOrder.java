...
public class DeliveryOrder {
    ...
    public void onPostPersist(){
        ...
        DeliveryOrderChanged deliveryOrderChanged = new DeliveryOrderChanged();
        BeanUtils.copyProperties(this, deliveryOrderChanged);
        deliveryOrderChanged.publishAfterCommit();
